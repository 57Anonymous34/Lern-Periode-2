...
while (true)
{
    ...
    if (eingabe == "y")
    {
        ...
        Console.WriteLine("2 Stein gewinnt gegen Schere");
        Console.WriteLine("3. Schere gewinnt gegen Papier");
        Console.WriteLine("4. Papier gewinnt gegen Stein");
        break;
    }
    else if (eingabe == "n")
...
{
    Console.WriteLine("Knappes Duel, leider Unentschieden.");
}
else if ((zahl1 == 1 && zufallszahl == 3) || 
                (zahl1 == 2 && zufallszahl == 1) || 
                (zahl1 == 3 && zufallszahl == 2))   
{
